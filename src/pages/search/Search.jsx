    ...
    <>
      ...
      >
        ...
        {data.length > 0 ? (
          ...
          >
            {data.map((movie) => (
              ...
              >
                ...
                <h3 className="mt-2 text-sm font-semibold md:text-[16px]">
                  {movie.title}
                </h3>
              </Link>
            ))}
          ...
          <div className="flex h-[400px] items-center justify-center text-sm text-white/50 md:text-[16px]">
            검색 결과가 없습니다.
          </div>
        )}
      </div>
