  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-5 text-white">
      <div className="flex w-full max-w-2xl flex-col items-center text-center">
        ...
        <Link
          to="/"
          className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 px-8 py-3.5 text-sm font-bold text-white transition hover:bg-red-800 sm:mt-8 sm:w-auto sm:px-10 sm:py-4 sm:text-base"
        >
